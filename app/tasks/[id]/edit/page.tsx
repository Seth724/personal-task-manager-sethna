  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        setError(err instanceof Error ? err.message : 'Unknown error while loading task')
      } finally {
        setIsPageLoading(false)
      }
    })()
            ...
            <form className="grid gap-3" onSubmit={onSubmit}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <Input
                  ...
                  required
                  defaultValue={task.dueDate ? task.dueDate.slice(0, 10) : ''}
                  className="shine-on-hover sm:col-span-1"
                />

                {/* Priority (right-aligned dropdown, extra offsets, high z-index) */}
                <Select name="priority" defaultValue={task.priority}>
                  <SelectTrigger className="shine-on-hover justify-between sm:col-span-1">
